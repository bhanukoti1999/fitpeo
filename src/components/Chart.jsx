...
const Chart = () => {
  ...
  return (
    <div className="justify-center items-center w-full h-[18.7em] mt-5 bg-white rounded-lg">
      <div className="flex-col justify-start items-center">
      <p className="text-xl text-start font-[500]">Customers</p>
      <p className="text-sm text-gray-500 float-left">Customers that buy products</p>
      </div>
      <ResponsiveContainer>
